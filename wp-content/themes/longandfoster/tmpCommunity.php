...
<div class="homepage">
  ...
  <div class="hero" style="background-image:url(<?php echo get_field('hero_background'); ?>); background-attachment: fixed;background-repeat: no-repeat;  background-position: center center;  background-size: cover;">
    <div class="fs-18 fc-white mt-100">Halifax County & South Boston, Virginia</div>
    <div class="fs-64 fs-40-m lh-44-m mb-16-m mt-16-m fc-dark-blue">Community</div>
  ...
  <div class="homepage__about">
    <div class="fs-18 fc-light-blue">Living In</div>
    <div class="fs-64 fs-40-m lh-44-m mb-16-m mt-16-m fc-dark-blue t-center">South Boston, <br class="mobile-break" /> Virginia</div>
    <div class="bg-dark-red hz-separator"></div>
    <div class="copy fc-dark-blue fs-18 mt-24">
  ...
  <div class="homepage__featured">
    <div class="container">
      <div class="fs-34 fc-dark-blue t-center mb-24">Things To Do</div>
      <div class="bg-dark-red hz-separator" style="margin:auto"></div>

      <div class="basic_copy">

        <div class="copy fc-dark-blue fs-18 mt-24 t-center">
  ...
  <div class="homepage__your-home">
    <div class="fs-18 fc-light-blue">Overview of </div>
    <div class="fs-64 fs-40-m lh-44-m mb-16-m fc-dark-blue">Halifax, Virginia</div>
    <div class="bg-dark-red hz-separator"></div>
    <div class="copy fc-dark-blue fs-18 mw-84 mt-24">
