...
<div class="mt-48 mw-75 mlra fx fx-justify-center fx-align-center fx-col">
  ...
  <div class="w-100 fx fx-row fx-align-center fx-justify-sa mb-32">
    <div class="bg-light-grey ht-48 fc-light-blue fw-3 w-150p br-50p fx fx-align-center fx-justify-center c-pointer">All</div>
    <div class="bg-dark-red ht-48 fc-white fw-3 w-150p br-50p fx fx-align-center fx-justify-center c-pointer">New Listings</div>
